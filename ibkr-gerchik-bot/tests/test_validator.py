...
class ValidatorTests(unittest.TestCase):
    ...
    def test_rejects_news_risk(self) -> None:
        signal = {
            "symbol": "AAPL",
            "signal": "BUY",
            "entry": 100.0,
        ...
        valid, reasons = validate_trade(signal, 100_000, [], 0.0, 0.001, has_symbol_news_risk=True)
        self.assertFalse(valid)
        self.assertIn("high_risk_news", reasons)
